package me.alexbanper.project.top.Utilies;
...
public class LocationSerialize implements ConfigurationSerializable{
	...
	public LocationSerialize (Map<String,Object> map) {
	...
	public LocationSerialize (Location l) {
		x = (float)l.getX();
		y = (float)l.getY();
		z = (float)l.getZ();
		yaw = (float) l.getYaw();
